...
const buyerIconMap: Record<string, React.ElementType> = { FileText, Search, Home, CheckSquare, Key };

const Buyers = () => {
  useEffect(() => {
    document.title = siteConfig.seo.buyers.title;
    document.querySelector('meta[name="description"]')?.setAttribute("content", siteConfig.seo.buyers.description);
  }, []);
      ...
      <section className="py-24 section-padding">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {siteConfig.buyerProcess.map((step, i) => {
              const Icon = buyerIconMap[step.icon] || FileText;
              return (
      ...
      <section className="py-24 bg-card section-padding">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {siteConfig.firstTimeBuyerTips.map((tip, i) => (
